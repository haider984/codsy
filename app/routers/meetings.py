...
async def create_meeting(
    ...
    """Creates a new meeting, automatically generating the meet_id."""
    try:
        # Use mode="json" for HttpUrl and handle datetime serialization if needed
        meeting_dict = meeting.model_dump()
        # Generate a new ObjectId for the meet_id field
        generated_meet_id = ObjectId()
        # Add the generated meet_id to the dictionary to be saved
        meeting_dict['meet_id'] = generated_meet_id

        # Insert the complete dictionary (including generated meet_id)
